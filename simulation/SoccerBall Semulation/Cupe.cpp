...
private:
	...
	void Draw()
	{
		...
		glBegin(GL_QUADS);
		glTexCoord2f(1.0, 0.0); glVertex3f(x, 0, z + size);    // Bottom Left Of The Quad (Bottom)
		glTexCoord2f(1.0 , 1.0); glVertex3f(x + size, 0, z + size);   // Bottom Right Of The Quad (Bottom)
		glTexCoord2f(0.0, 1.0); glVertex3f(x + size, 0, z);   // Top Right Of The Quad (Bottom)
		glTexCoord2f(0.0, 0.0); glVertex3f(x, 0, z);    // Top Left Of The Quad (Bottom)
		glEnd();
