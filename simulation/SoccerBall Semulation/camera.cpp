...
Camera::Camera(double cameraX, double cameraY, double cameraZ)
{
	this->x = cameraX;
	this->y = cameraY+25 ;
	this->z = cameraZ;
	Position = Vector3dCreate(x, y, z);
...
void Camera::setter(double cameraX, double cameraY, double cameraZ){
	this->x = cameraX;
	this->y = cameraY+25 ;
	this->z = cameraZ;
	Position = Vector3dCreate(x, y, z);
...
void Camera::setView(double Dx){
		View = Vector3dCreate(Dx, -0.3, 0.0);
}
